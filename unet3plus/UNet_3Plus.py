...
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True, last_activation='sigmoid',auxiliary=False):
...
#     UNet 3+ with deep supervision and class-guided module
# '''
# class UNet_3Plus_DeepSup_CGM_revised(nn.Module):

#     def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True,auxiliary=False):
#         super(UNet_3Plus_DeepSup_CGM, self).__init__()
#         self.is_deconv = is_deconv
#         self.in_channels = in_channels
#         self.is_batchnorm = is_batchnorm
